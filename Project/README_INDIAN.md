...
- **AI-Powered Categorization**: Use Claude AI to automatically suggest categories based on descriptions (requires Anthropic API key)
...
If you have an Anthropic API key, enter it when prompted to enable AI features.
...
7. Add Expense with AI Categorization (if API key provided) - AI suggests category based on description
